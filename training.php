...
<body class="">
    ...
    <div id="" class="sideNav">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="teaching.php "
                class="features   list-group-item list-group-item-action d-flex flex-column justify-content-center align-items-center">
                <i class="fas fa-chalkboard"></i>
                <p class="features-text">Teaching</p>
            </a>

            <a href="training.php"
                class="features  active list-group-item list-group-item-action d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="row justify-content-center">
            ...
            <div id="curriculum-content" class="card col-lg-8 col-xl-9  bg-white">
                ...
                <div id="video-wrapper" class=" w-100  mt-4">
                    ...
                    <div>
                        <h5 class="l">Training Course Theme: The Perfect Staff</h5>
                    </div>
                    <!--End Video Content-->
                </div>
                ...
                <div class=" mb-5  mt-4">
                    ...
                    <a type="submit" name="addComment"
                        class="btn-sm btn-white my-2 comment-btn p-2 float-right commentDetails" onclick="addComment()"
