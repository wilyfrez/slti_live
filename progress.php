...
<body class="">
    ...
    <div id="" class="sideNav">
        ...
        <div class="list-group list-group-flush">
           ...
           <a href="teaching.php " class="features  active list-group-item list-group-item-action d-flex flex-column justify-content-center align-items-center">
           ...
           <a href="mentoring.php" class="features   list-group-item list-group-item-action d-flex flex-column justify-content-center align-items-center">
               <i class="fas fa-chalkboard-teacher"></i>
               <p class="features-text">Mentoring</p>
           </a>
       
      
           <a href="progress.php" class="features active list-group-item list-group-item-action d-flex flex-column justify-content-center align-items-center">
